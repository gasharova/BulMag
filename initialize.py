...
bloom_filter_only_md5 = BloomFilter(bit_array_size=100, hash_functions_list=only_md5)
bloom_filter_both = BloomFilter(bit_array_size=100, hash_functions_list=both)
